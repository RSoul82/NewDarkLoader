...
namespace NewDarkLoader
{
    ...
    class SevenZipGExtract
    {
        ...
        /// <param name="fmArchiveDir">Where the archive is kept.</param>
        ...
        public static int ExtractFile(string sevenZipGPath, string fmArchiveDir, string archiveFilename, 
        ...
        /// <param name="archiveFullPath">Full path of archive</param>
        /// <param name="extractionPath">Where to extract the file(s). Include the "Extraction name" in the path.</param>
        public static int ExtractArchive(string sevenZipGPath, string archiveFullPath,
            string extractionPath)
        {
            ...
            p.StartInfo.FileName = "\"" + sevenZipGPath + "\"";
            p.StartInfo.WorkingDirectory = Path.GetDirectoryName(sevenZipGPath);
            p.StartInfo.Arguments = "x " + "\"" + archiveFullPath + "\""
                + " -o\"" + extractionPath + "\" -y";
